...
In 2017, a team at Google published a paper called "Attention Is All You Need." The transformer was born. And it changed everything.
...
## Objectives
- Set expectations for the project and outcomes.
- Outline the end-to-end LLM we will build.

## Notes
_TBD as the chapter is written._

## Checkpoint
- Suggested tag: `chapter-01-intro`.
